exports.command = function (title, barcode, description, isNew) {
  ...
  if (title) {
    this
      ...
      .verify.elementPresent("#unorderedList li:nth-child(1)")
      .verify.elementPresent("#unorderedList li:nth-child(1) article")
      .verify.elementPresent("#unorderedList li:nth-child(1) article .barcode")
      .verify.elementPresent("#unorderedList li:nth-child(1) article .titleText")
      .verify.elementPresent("#unorderedList li:nth-child(1) article .descriptionText")
      .verify.containsText("#unorderedList li:nth-child(1) article .titleText", title);

    if (description) {
      this.verify.containsText("#unorderedList li:nth-child(1) article .descriptionText", description);
    }
    if (barcode) {
      this.verify.containsText("#unorderedList li:nth-child(1) article .barcode", barcode)
    }
  }
