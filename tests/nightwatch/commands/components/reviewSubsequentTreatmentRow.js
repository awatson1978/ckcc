exports.command = function() {
  this
    ...
    .verify.elementPresent("table tbody tr .Resolved_Date")
    .verify.elementPresent("table tbody tr .Drug_Name")
    .verify.elementPresent("table tbody tr .Reason_for_Stopping_Treatment")
    .verify.elementPresent("table tbody tr .Responder")
    .verify.elementPresent("table tbody tr .ResponderEnzalutamide")
    .verify.elementPresent("table tbody tr .ResponderAbiraterone")
    .verify.elementPresent("table tbody tr .ResponderOtherTherapy")
